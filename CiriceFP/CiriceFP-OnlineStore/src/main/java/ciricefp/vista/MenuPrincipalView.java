...
public class MenuPrincipalView {
    ...
    private static Scene generateScene() {
        ...
        ClassLoader classLoaderImg = Thread.currentThread().getContextClassLoader();
        String uri = String.valueOf(Objects.requireNonNull(classLoaderImg.getResource("logo-cirice.png")));
        Image logo = new Image(uri);
